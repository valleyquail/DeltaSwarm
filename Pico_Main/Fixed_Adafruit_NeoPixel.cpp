// Modified by Nikesh Walling
// Needs to be modified to prevent conflicts with using the PIO state machine on
// the RP2040 since otherwise it will overwrite the encoder state machine

//Just copy and paste this file into the ./pio/libdeps/pico/Adafruit NeoPixel/Adafruit_NeoPixel.cpp
