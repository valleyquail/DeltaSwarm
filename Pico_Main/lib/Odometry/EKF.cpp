...
void EKF::init()
{
    ...
    Vector4f initialState = {1.0f, 0.0f, 0.0f, 0.0f};                          // Initial quaternion state
    Matrix<float, 4, 4> initialCovariance = Eigen::DiagonalMatrix<float, 4>(); // Initial covariance matrix
